                    ...
                    <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                        ...
                        <div className="flex pt-16">
                            ...
                            <button
                                ...
                                className={`rounded-full w-10 h-10 ${beer.liked ? "bg-green" : "bg-lightgreen"} p-0 border-0 inline-flex items-center hover:bg-lightgreenhover justify-center text-gray-500 ml-4`}
                            >
