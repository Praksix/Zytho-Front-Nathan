...
function BiereDetail() {
	...
	const fetchBeer = async () => {
		const response = await fetch(
			`http://localhost:3004/api/v1/beers/${id}`
		);
					...
					<div className="lg:w-4/5 mx-auto flex flex-wrap">
						<div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0" >
							...
							<div className="flex mb-4">
								<a className="flex-grow text-white border-b-2 border-lightgreen py-2 text-lg px-1">Description</a>
							...
							<div className="flex pt-16">
								...
								<button className="flex ml-auto text-white bg-lightgreen border-0 py-2 px-6 focus:outline-none hover:bg-lightgreenhover rounded">Commander</button>
								<button className="rounded-full w-10 h-10 bg-lightgreen p-0 border-0 inline-flex items-center hover:bg-lightgreenhover justify-center text-gray-500 ml-4">
